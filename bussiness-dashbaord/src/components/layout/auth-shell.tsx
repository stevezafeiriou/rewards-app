...
export function AuthShell({
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[1360px] items-center px-4 py-5 sm:px-6 lg:px-8">
      <div className="app-card grid min-h-[78vh] w-full overflow-hidden lg:grid-cols-[1.02fr_0.98fr]">
